...
**All CORDEX domains are now available. These are: AFR-22, SEA-22, EAS-22, WAS-22, AUS-22,CAM-22, SAM-22, CAS-22, EUR-22 and NAM-22**
...
sudo docker pull docker.io/rso9192/cava:version3.2.0

sudo docker run --rm \
           -p 8888:8787 \
           -e PASSWORD=password \
           -v /path/to/local/directory:/home \
           rso9192/cava:version3.2.0
