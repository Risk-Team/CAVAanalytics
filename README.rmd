...
If you have already installed most of the climaterR packages, you can install cavaR from GitHub:
...
```
If you are also new to climate4R, install its main packages first. The best way is to install all climate4R libraries through conda/mamba. If you want to know more about using conda and environments with R, have a look at [this quick tutorial](https://github.com/RSO9192/conda_R).
