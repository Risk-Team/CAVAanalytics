...
plotting(., plot_titles = "N.days > 35/year",legend_range = c(-3,3), palette=IPCC_palette(type="tmp", divergent=T))
```
...
and without spatial or temporal aggregation. In this case we are looking at the frequency distribution of the yearly data across all pixels (no spatial aggregation)
...
It is also possible to look at how anomalies have progressed
...
plotting(ccs_kenya, plot_titles = "Mean tasmax change", temporal=T,palette=c("blue", "red"))
