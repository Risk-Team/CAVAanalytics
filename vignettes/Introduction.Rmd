...
plotting(trd_kenya, ensemble=T, plot_titles = "N. members direction change", frequencies = F, spatial_aggr = F, palette = c("blue", "green", "white", "yellow", "red"))
...
Similar to analyzing projections, we can also examine historical data using the loaded observational dataset, which, in this case, is ERA5.


```{r, fig.height=4, fig.width=6,  message=F, warning=F}

proj_kenya_obs <- observations(kenya_exmp, season=1:12)

plotting(proj_kenya_obs, plot_titles = "Mean tasmax")
