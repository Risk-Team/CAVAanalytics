...
We can now verify that the data is bias-corrected by comparing it against the observations for  the number of very warm days (days with maximum temperature above 35 °C)
...
As shown above, the biases are negligible. This means you can directly use the data for projections and climate change signal analysis without needing to apply bias correction:
