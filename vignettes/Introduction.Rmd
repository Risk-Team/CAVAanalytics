...
trends=F, plot_titles = "mean tasmax biases")
```
...
plot_titles = "N.days > 35", palette=c("white", "orange", "red", "darkred"))
```
...
plot_titles = "N.days > 35 after bc", 
...
plotting(trd_kenya.obs, ensemble=F, 
...
plot_titles = "N. members direction change",
...
plotting(trd_kenya.prj, ensemble=T, spatial_aggr = F, 
