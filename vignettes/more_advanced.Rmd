...
plotting(hwvs, plot_titles = "N° of heat waves", ensemble = T, palette = c("white", "orange", "red", "darkred", "brown"))

```

and their temporal 

```{r,  warning=F, message=FALSE, fig.height=3, fig.width=6}
...
```{r,  warning=F, message=FALSE, fig.height=6, fig.width=4}
