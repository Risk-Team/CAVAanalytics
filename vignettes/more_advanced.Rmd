...
projections(kenya_exmp, season = list(1:3,4:6,7:9,10:12), consecutive=T, duration=3, uppert=35, frequency=T) %>%
  plotting(., plot_titles = "N° of heat waves", ensemble = T, palette = c("white", "orange", "red", "darkred", "brown"))
